...
$(document).ready(function(){
    $("#Poster1").on('click', function(){
		...
		$('html,body').animate({
			scrollTop: $("#Synopsis1").offset().top},
			'slow');
    });
});
...
$(document).ready(function(){
    $("#Poster2").on('click', function(){
		...
		$('html,body').animate({
			scrollTop: $("#Synopsis2").offset().top},
			'slow');
    });
});
...
$(document).ready(function(){
    $("#Poster3").on('click', function(){
		...
		$('html,body').animate({
			scrollTop: $("#Synopsis3").offset().top},
			'slow');
    });
});
...
$(document).ready(function(){
    $("#Poster4").on('click', function(){
		...
		$('html,body').animate({
			scrollTop: $("#Synopsis4").offset().top},
			'slow');
    });
});
...
$(document).ready(function(){
	$.post("http://titan.csit.rmit.edu.au/~e54061/wp/movie-service.php", function(movies){
		$("#RCTitle").text(movies.RC.title);
		$("ACTitle").text(movies.AC.title);
		$("CHTitle").text(movies.CH.title);
		$("AFTitle").text(movies.FO.title);
		$("#Poster1").attr("src",movies.RC.poster);
		$("#Poster2").attr("src",movies.AC.poster);
		$("#Poster3").attr("src",movies.CH.poster);
		$("#Poster4").attr("src",movies.FO.poster);
	}, 'json');
});
